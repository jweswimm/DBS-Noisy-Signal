...
figure()
subplot(3,1,1);
plot(t,KSTN_store(1,:)); hold on; plot(t,KSTN_store(5,:));
title('STN (N gating variable)')
xlabel('time [ms]')

subplot(3,1,2);
plot(t,KGPE_store(1,:)); hold on; plot(t,KGPE_store(5,:));
title('GPE (N gating variable)')
xlabel('time [ms]')

subplot(3,1,3);
plot(t,KGPI_store(1,:)); hold on; plot(t,KGPI_store(5,:));
title('GPI (N gating variable)')
xlabel('time [ms]')
